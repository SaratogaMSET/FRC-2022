...
public class ChassisSpeeds2 {
   ...
   */
  public static ChassisSpeeds2 fromFieldRelativeSpeeds(
    ...
    return new ChassisSpeeds2(
        vxMetersPerSecond * (joystickAngle-robotAngle.getCos()) + vyMetersPerSecond * (joystickAngle-robotAngle.getSin()),
        -vxMetersPerSecond * (joystickAngle-robotAngle.getSin()) + vyMetersPerSecond * (joystickAngle-robotAngle.getCos()),

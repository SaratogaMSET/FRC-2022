...
public class Intake extends SubsystemBase {
        ...
        public Intake() {
                ...
                rightValve = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.IntakeConstants.MODULE_NUMBER[0]); // PAREMETERS: ???, foward channel, reverse channel
                leftValve = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.IntakeConstants.MODULE_NUMBER[1]); // PAREMETERS: ???, foward channel, reverse channel
        }
        @Override
        ...
        public void stopAll() {
                ...
                if(rightValve.get()) rightValve.toggle();
                //if(leftValve.get()) leftValve.toggle();
        }
        public IntakeState updateState() {
                ...
                else if (rightValve.get() == true) return IntakeState.FLIP_DOWN;

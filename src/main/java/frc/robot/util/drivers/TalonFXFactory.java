...
public class TalonFXFactory {
    ...
    public static class Configuration {
        ...
        public StatorCurrentLimitConfiguration STATOR_CURRENT_LIMIT = new StatorCurrentLimitConfiguration(false, 0, 0, 0);
        public SupplyCurrentLimitConfiguration SUPPLY_CURRENT_LIMIT = new SupplyCurrentLimitConfiguration(false, 0, 0, 0);
...
//     }
    ...
    public static LazyTalonFX createDefaultTalon(int id) {
        return createTalon(id, kDefaultConfiguration);
    }

    public static LazyTalonFX createPermanentSlaveTalon(int id, TalonFX master) {
        final LazyTalonFX talon = createTalon(id, kDefaultConfiguration);
        talon.follow(master);
        return talon;
    }
    public static LazyTalonFX createPermanentSlaveTalon(int id, TalonFX master, boolean inverted) {
        final LazyTalonFX talon = createTalon(id, kDefaultConfiguration);
        talon.follow(master);
        talon.setInverted(inverted ? TalonFXInvertType.OpposeMaster : TalonFXInvertType.FollowMaster);
        return talon;
    }

    public static LazyTalonFX createTalon(int id, Configuration config) {
